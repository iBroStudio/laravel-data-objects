...
return [
    'dto' => [
        'casts' => [
            ...
            EloquentModelReference::class => DtoValueObjetCastTransformer::class,
            ...
            ValueObjects\Money::class => DtoValueObjetCastTransformer::class,
            ValueObjects\Name::class => DtoValueObjetCastTransformer::class,
            ValueObjects\Percentage::class => DtoValueObjetCastTransformer::class,
